...
Query.prototype.include = function() {
  if(typeof(arguments[0]) == 'string') {
    ...
    if(association.through) {
      ...
      this.leftJoin(association.model.modelName, association.model.getIdColumn().dbColumnName, {tableAlias: join.tableAlias, dbColumnName: association.manyToManyForeignKey});
    } else {
